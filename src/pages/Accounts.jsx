...
const Accounts = ({ onViewDetails }) => {
  ...
  return (
    <div className="nexus-page accounts-page fade-in">
      <header className="page-top"><div><span className="eyebrow">Account inventory</span><h1>Accounts</h1><p>{accounts.length} PSN assets indexed by games, slots, and money.</p></div><button type="button" className="icon-shell add-account-icon" onClick={openAddAccount} aria-label="Add account"><Plus size={21}/></button></header>
