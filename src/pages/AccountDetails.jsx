...
const AccountDetails = ({ id, accountId, onBack }) => {
  ...
  return <div className="nexus-page details-page fade-in">
    <header className="details-top"><button className="icon-shell" onClick={onBack}><ArrowLeft size={20}/></button><div><p>{account.region} - {account.condition}</p></div><button className="icon-shell"><Copy size={19}/></button></header>
