...
const SellSlot = ({ onComplete }) => {
  ...
  return (
    <div className="nexus-page sell-page fade-in">
      <header className="page-top"><div><p>Start with the game the customer wants.</p></div>{selectedGame && <button className="icon-shell" onClick={()=>{setSelectedGame(null); setSelected(null);}}><ChevronLeft size={21}/></button>}</header>
